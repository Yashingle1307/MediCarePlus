...
import { User, Mail, Phone, MapPin, MessageSquare, SendHorizontal, Stethoscope } from 'lucide-react';
...
const ContactPage = () => {
    ...
    function handleSubmit(e) {
        ...
        const url = `https://wa.me/7875546484?text=${encodeURIComponent(text)}`;
    ...
    const availabelServices = form.department
                ...
                <div className={contactPageStyles.infoContainer}>
                    <div className={contactPageStyles.infoCard}>
                        ...
                        <p className={contactPageStyles.infoText}>
                            Waghloi, Pune, Mahrashtra
                        </p>

                        <p className={contactPageStyles.infoItem}>
                            <Phone size={16} /> 7875546484
                        </p>
                    ...
                    <iframe
                        src="https://www.google.com/maps?q=Wagholi,+Pune,+Maharashtra&output=embed"
                        className={contactPageStyles.map}
                        title="Wagholi Pune Map"
                        loading="lazy"
                        allowFullScreen
                    ></iframe>
