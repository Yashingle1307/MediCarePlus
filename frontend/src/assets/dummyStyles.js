...
export const listPageStyles = {
  // Main container
  pageContainer:
    "min-h-screen pt-32 md:pt-36 lg:pt-40 font-serif px-6 sm:px-8 md:px-12 lg:px-16 py-10 bg-linear-to-br from-emerald-50 to-white",
...
export const editProfilePageStyles = {
  // Page container
  pageContainer:
    "min-h-screen font-serif bg-linear-to-br from-emerald-50 via-white to-emerald-50/30 p-8 sm:p-10 md:p-14 lg:p-18 xl:p-24 2xl:p-28",
...
export const dashboardStyles = {
  // Main container
  pageContainer:
    "min-h-screen font-serif pt-32 md:pt-36 lg:pt-40 p-4 sm:p-6 bg-linear-to-br from-emerald-50 to-white",
  // Content wrapper
  contentWrapper: "max-w-7xl mx-auto",
