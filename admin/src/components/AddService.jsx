...
const AddService = ({ serviceId }) => {
    ...
    // submit function for update or creation
    ...
    return (
        <div className={ad.container.main}>
            <div className={ad.toast.container}>
                {toast && (
                    <div className={`${ad.toast.toastBase}${toast.type === 'error' ? ad.toast.toastError :
                        toast.type === "info" ? ad.toast.toastInfo :
                            ad.toast.toastSuccess
                        } animate-slideIn`}>
                        ...
                        <div className="flex-1 min-w-0">
                            <div className={ad.toast.title}>
                                {toast.title}
                            </div>
                            <div className={ad.toast.message}>
                                {toast.message}
                            </div>
                        </div>
            ...
            <form onSubmit={handleSubmit} className={ad.container.form}>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
                    ...
                    <div className={ad.headerActions}>
                        <button type="button" onClick={resetForm} className={ad.buttons.reset}>
                            Reset
                        </button>

                        <button type="submit" disabled={submitting} className={ad.buttons.submit}>
                            {submitting ? (
                                <>
