...
import { BadgeIndianRupee, Calendar, CheckCircle, ClipboardList, Search, XCircle, XCircleIcon } from 'lucide-react';
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
    ...
    useEffect(() => {
        ...
        // a polling tab which is visible
            ...
            <div className={sd.innerContainer}>
                ...
                <div className={sd.header.container}>
                    ...
                    <div className={sd.refresh.container}>
                        <div className={sd.refresh.countText}>
                            {loading ? "Loading..." :
                        ...
                        <button onClick={() => {
                            ...
                            className={sd.refresh.button(Array.isArray(servicesProp))}
                            title={
                ...
                <div className={sd.table.container}>
                    <div className={sd.table.headerMd}>
                        <div className={sd.table.headerText}>Service</div>
                        <div className={sd.table.headerText}>Appointments</div>
                        <div className={sd.table.headerText}>Completed</div>
                        <div className={sd.table.headerText}>Canceled</div>
                        <div className={sd.table.headerText}>Earning</div>
                    </div>
                </div>
                ...
                <div className={sd.table.headerLg}>
                    ...
                    <div className={sd.table.headerTextLg(1)}>Appointments</div>
                    <div className={sd.table.headerTextLg(1)}>Completed</div>
                    <div className={sd.table.headerTextLg(1)}>Canceled</div>
                    <div className="col-span-2 text-right">Earning</div>
                </div>

                <div className={sd.table.body}>
                    {loading ? (
                        <div className={sd.states.loading}>
                            Loading Services...
                        </div>
                    )
                        : error ? (
                            <div className={sd.states.error}>
                                Error:{error}
                            </div>
                        ) :
                            visibleServices.length == 0 ? (
                                <div className={sd.states.empty}>
                                    No services found.
                                </div>
                            ) : (
                                        ...
                                        <div className={sd.table.row}>
                                            ...
                                            <div className={sd.table.tabletView}>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className={sd.table.tabletTextContainer}>
                                                        <div className={sd.table.tabletServiceName}>
                                                            {s.name}
                                                        </div>

                                                        <div className={sd.table.tabletPrice}>
                                            ...
                                            <div className={sd.table.desktopView}>
                                                <div className="col-span-5 flex items-center gap-4">
                                                    ...
                                                    <h3 className={sd.table.desktopServiceName}>
                                                        {s.name}
                                                    </h3>
                                                </div>

                                                <div className={sd.table.desktopCell(2)}>
                                                    {formatCurrency(s.price)}
                                                </div>

                                                <div className={sd.table.desktopCenterCell(1)}>
                                                    {s.totalAppointments}
                                                </div>
                                                ...
                                                <div className={`${sd.table.desktopCell(2)} text-right`}>
                                            ...
                                            <div className={sd.table.mobileView}>
                                                <div className="flex items-start gap-3">
                                                    <div
                                                        className={sd.table.mobileImage}
                                                    >
                                                        <img
                                                            src={s.image}
                                                            alt={s.name}
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div
                                                            className={
                                                                sd.table.mobileServiceHeader
                                                            }
                                                        >
                                                            <h3
                                                                className={
                                                                    sd.table.mobileServiceName
                                                                }
                                                            >
                                                                {s.name}
                                                            </h3>
                                                        ...
                                                        <div
                                                            className={
                                                                sd.table.mobileStatsContainer
                                                            }
                                                        >
                                                            <div
                                                                className={sd.table.mobileStatItem(
                                                                    "emerald",
                                                                )}
                                                            >
                                                                <Calendar size={14} />
                                                ...
                                                {filteredServices.length > INITIAL_COUNT &&(
                                                    <div className={sd.showMore.container}>
                                                        <button onClick={()=>setShowAll((s)=>!s)} className={sd.showMore.button}>
                                                            {showAll ? "Show less":
...
function StatCard({ icon, label, value }) {
    return (
        <div className={sd.statCard.container}>
